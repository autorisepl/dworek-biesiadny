        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            <p className="font-body text-gray-600 leading-relaxed mb-6 text-base md:text-lg">
              Kopuła o powierzchni 37,5 m² stoi przy starorzeczu Warty, na skraju rozległych
              polan. Wewnątrz — pełen komfort noclegowy z widokiem na naturę przez
              transparentne ściany.
            </p>
            <p className="font-body text-gray-600 leading-relaxed mb-8">
              Kopuła sprawdza się również jako przestrzeń eventowa: komunie, osiemnastki i
              kameralne wesela w plenerze, bez rezygnacji z wygody. Cisza, przestrzeń i brak
              sąsiadów za ścianą w cenie.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              {glampingFeatures.map((f) => (
                <div
                  key={f.label}
                  className="flex items-center gap-3 bg-cream rounded-lg p-3 font-body text-sm text-gray-700"
                >
            ...
            <div className="flex gap-4">
              <Link
                ...
                className={cn(
                  ...
                  "bg-primary hover:bg-primary-dark text-white font-body font-medium px-6"
                )}
              >
                Zarezerwuj kopułę
              </Link>
              <Link
                href="/glamping"
                className="inline-flex items-center font-body text-sm text-primary hover:text-primary-dark transition-colors"
              >
                Dowiedz się więcej →
              </Link>
            </div>
